...
//   // Styles object defined within the component
//   const styles = {
//     businessGrowth: {
...
//       width: "4px",
//       height: "100%",
//       background: "repeating-linear-gradient(to bottom right, #7dc10d, #7dc10d 5px, #1b2942 5px, #1b2942 10px)",
...
//       width: "120px",
//       height: "4px",
//       background: "repeating-linear-gradient(to right, #7dc10d, #7dc10d 10px, transparent 10px, transparent 20px)",
//       margin: "10px auto",
//     },
...
//   return (
//     <div style={styles.businessGrowth}>
//       {/* Growth Heading */}
//       <div style={styles.growthHeading}>
//         <h2 style={styles.growthHeadingTitle}>Your Unstoppable Force for Driving Business Growth</h2>
//       </div>
...
//             <h3 style={styles.statItemHeading}>{stat.number}</h3>
...
//             clearInterval(intervals[index]);
//           }
//         }, 150); // Slower interval of 300ms for smoother animation
//       });
...
//     <div ref={sectionRef} style={styles.businessGrowth}>
//       <div style={styles.growthHeading}>
//         <h2 style={styles.growthHeadingTitle} className="mil-upper mil-up mil-mb-30" >Your Unstoppable Force for Driving Business Growth</h2>
//       </div>
